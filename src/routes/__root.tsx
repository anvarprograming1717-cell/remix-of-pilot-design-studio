...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Exora — Crypto Trading Platform" },
      {
        name: "description",
        content:
          "Exora is a next-generation crypto trading terminal with real-time charts, deep liquidity and a liquid-glass interface.",
      },
